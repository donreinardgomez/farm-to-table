...
export const dummyManufacturers: IManufacturer[] = [
  {
    ...
    rating: 1,
    thumbnail: `man-logo-${getRandomNumber(20)}`,
    aiFeedback: loremClass.generateParagraphs(getRandomNumber(5)),
    overview: loremClass.generateParagraphs(getRandomNumber(2)),
